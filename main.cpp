...
// motor groups
pros::MotorGroup leftMotors({-18, -11, -2},
...
lemlib::TrackingWheel horizontal(&horizontalEnc, lemlib::Omniwheel::NEW_275, -4.75);
...
void initialize() {
    ...
    //     pros::lcd::print(1, "Horizontal Rotation Sensor: %i", horizontalEnc.get_position());
